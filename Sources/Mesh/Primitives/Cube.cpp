...
Cube::Cube(Position3 position, float size, const Texture& texture) : Mesh() {
	...
	faces.insert(faces.end(),
		new Scratchy::Rect(position + Position3(size / 2, size / 2, -size / 2),    // BACK FACE
			position + Position3(-size / 2, size / 2, -size / 2),
			position + Position3(-size / 2, -size / 2, -size / 2),
			position + Position3(size / 2, -size / 2, -size / 2),
			texture));
	faces.insert(faces.end(),
		new Scratchy::Rect(position + Position3(-size / 2, size / 2, size / 2),    // FRONT FACE
			position + Position3(size / 2, size / 2, size / 2),
			position + Position3(size / 2, -size / 2, size / 2),
			position + Position3(-size / 2, -size / 2, size / 2),
			texture));
	faces.insert(faces.end(),
		new Scratchy::Rect(position + Position3(size / 2, size / 2, size / 2),    // RIGHT FACE
			position + Position3(size / 2, size / 2, -size / 2),
			position + Position3(size / 2, -size / 2, -size / 2),
			position + Position3(size / 2, -size / 2, size / 2),
			texture));
	faces.insert(faces.end(),
		new Scratchy::Rect(position + Position3(-size / 2, size / 2, -size / 2),    // LEFT FACE
			position + Position3(-size / 2, size / 2, size / 2),
			position + Position3(-size / 2, -size / 2, size / 2),
			position + Position3(-size / 2, -size / 2, -size / 2),
			texture));
	faces.insert(faces.end(),
		new Scratchy::Rect(position + Position3(-size / 2, size / 2, -size / 2),    // TOP FACE
			position + Position3(size / 2, size / 2, -size / 2),
			position + Position3(size / 2, size / 2, size / 2),
			position + Position3(-size / 2, size / 2, size / 2),
			texture));
	faces.insert(faces.end(),
		new Scratchy::Rect(position + Position3(-size / 2, -size / 2, size / 2),    // BOT FACE
			position + Position3(size / 2, -size / 2, size / 2),
			position + Position3(size / 2, -size / 2, -size / 2),
			position + Position3(-size / 2, -size / 2, -size / 2),
			texture));
