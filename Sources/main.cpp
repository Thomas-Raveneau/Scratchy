...
//	// ------------------------------------
//	Scratchy::Shader ourShader("../Shaders/Vertex/triangle_textured.vs", "../Shaders/Fragment/texture.fs");
//
...
//	unsigned char *data = stbi_load("../Ressources/Textures/mc_texture.jpg", &width, &height, &nrChannels, 0);
//	if (data)
//	{
...
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
//	// load image, create texture and generate mipmaps
//	data = stbi_load("../Ressources/Textures/smiley.png", &width, &height, &nrChannels, 0);
//	if (data)
//	{
